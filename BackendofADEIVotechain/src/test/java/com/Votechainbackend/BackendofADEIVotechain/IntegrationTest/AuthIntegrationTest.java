...
public class AuthIntegrationTest {
    ...
    public void testUserRegistrationAndAuthentication() throws Exception {
        // User registration
        String registrationRequest = "{\"name\":\"John Doe\",\"apogeecode\":\"924120023\",\"email\":\"john.doe93@example.com\",\"password\":\"password123\"}";
        ...
        // User authentication
        String authenticationRequest = "{\"apogeecodeOrEmail\":\"john.doe93@example.com\",\"password\":\"password123\"}";
